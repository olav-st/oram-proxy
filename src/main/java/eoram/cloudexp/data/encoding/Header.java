...
public abstract class Header 
{
	...
	public static Header load(ObjectInputStream is) throws Exception
	{
		...
		else if(simpleName.equalsIgnoreCase("ObliviStoreHeader")) { return new ObliviStoreHeader(b); }
		else if(simpleName.equalsIgnoreCase("FrameworkHeader")) { return new FrameworkHeader(b); }
